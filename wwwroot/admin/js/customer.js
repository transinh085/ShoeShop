document.addEventListener("DOMContentLoaded", function () {
    ...
    $("#modal-edit-customer").on("hidden.bs.modal", function () {
        // Xóa các lớp CSS liên quan đến lỗi validation
        $("#val-username-edit").removeClass("is-invalid");
    $("#val-email-edit").removeClass("is-invalid");
    $("#val-birthday-edit").removeClass("is-invalid");
    $("#val-fullname-edit").removeClass("is-invalid");
    $("#val-phone-edit").removeClass("is-invalid");
    ...
    Swal.fire("Error!", "Deletion of the customer was not successful.", "error");
        ...
        const pagination = new Pagination(null, "/Admin/Customers/allCustomers", getCustomerList, "searchInput");
